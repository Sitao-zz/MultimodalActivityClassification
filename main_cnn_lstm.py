...
from models.cnn_lstm import create_cnn_lstm
...
def run():
    ...
    for i in range(5):
        ...
        model_iner = create_cnn_lstm(input_shape_iner, num_classes)
        model_ske = create_cnn_lstm(input_shape_ske, num_classes)
        if i == 0:
