...
from models.lstm_simple import create_lstm_layers_iner, create_lstm_layers_ske


def create_lstm_ensemble(input_shape_iner, input_shape_ske, num_classes):
    ...
    ske_lstm_out, skeleton_out = create_lstm_layers_ske(skeleton_input, input_shape_ske, num_classes, "skeleton_output")
